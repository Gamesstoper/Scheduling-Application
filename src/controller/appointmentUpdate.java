...
public class appointmentUpdate implements Initializable {
    ...
    public void sendInfo(appointment appointment) {
        model.appointment.setFields(appointment, appointmentDescription, appointmentID, appointmentTitle,
                appointmentLocation, appointmentContact, appointmentDate, customerID, userID
    ...
    public void save(ActionEvent event) throws SQLException, IOException {
        ...
        if (hasConflict(sqlStart, sqlEnd) == true){
            ...
            PreparedStatement ps = JDBC.connection.prepareStatement("update client_schedule.appointments\n" +
